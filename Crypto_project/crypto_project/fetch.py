...
from login.models import CryptoCurrency
def fetch_and_store_crypto_data():
    # API endpoint
    api_url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=cad&order=market_cap_desc&per_page=30&page=1&sparkline=false&locale=en"
